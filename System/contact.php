...
<head>
	...
	<title>WORK-HORIZON - Contact Us</title>
    ...
    <meta property="og:image:alt" content="work-horizon Jobs" />
	...
	<link href="css/images/main.css" rel="stylesheet">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/hero-header/logo.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								...
								<li>
										<h5>Phone Number</h5><a href="tel:+639777305075">+639 777 305 075</a>
								</li>
